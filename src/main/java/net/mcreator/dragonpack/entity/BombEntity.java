...
public class BombEntity extends AbstractArrow implements ItemSupplier {
	public BombEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(DragonPackModEntities.BOMB.get(), world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(DragonPackModItems.BOMB.get());
	}
	...
	public static BombEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		BombEntity entityarrow = new BombEntity(DragonPackModEntities.BOMB.get(), entity, world);
	...
	public static BombEntity shoot(LivingEntity entity, LivingEntity target) {
		BombEntity entityarrow = new BombEntity(DragonPackModEntities.BOMB.get(), entity, entity.level);
